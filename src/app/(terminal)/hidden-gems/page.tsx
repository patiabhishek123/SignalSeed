...
export default function HiddenGemsPage() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col gap-6 animate-pulse">
        <div className="h-8 bg-[#1E2023] rounded w-64"></div>
        <div className="h-4 bg-[#1E2023] rounded w-96"></div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-[#111317] border border-[#3c4a42]/20 h-48 rounded-xl p-5 flex flex-col justify-between">
              <div className="space-y-3">
                <div className="h-4 bg-[#1E2023] rounded w-20"></div>
                <div className="h-6 bg-[#1E2023] rounded w-40"></div>
                <div className="h-3 bg-[#1E2023] rounded w-full"></div>
                <div className="h-3 bg-[#1E2023] rounded w-5/6"></div>
              </div>
              <div className="h-8 bg-[#1E2023] rounded w-full"></div>
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="font-mono text-[9px] uppercase tracking-wider px-3 py-1 bg-[#111317] border border-[#3c4a42]/30 text-primary hover:bg-[#1E2023]"
          >
      ...
      {isEmpty ? (
        /* Empty State */
        <div className="flex flex-col items-center justify-center min-h-[350px] border border-dashed border-[#3c4a42]/30 rounded-xl p-8 text-center bg-[#111317]/20">
          <span className="material-symbols-outlined text-[#bbcabf]/30 text-5xl mb-4">
            diamond
          </span>
          <h3 className="font-sans text-sm font-bold text-white uppercase tracking-wider mb-2">
            No Hidden Gems Flagged
          </h3>
          <p className="font-mono text-xs text-[#bbcabf]/50 max-w-sm leading-relaxed mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={index}
              className="glass-card rounded-xl p-5 flex flex-col justify-between gap-4 border border-[#3c4a42]/30 hover:border-primary/50 transition-all shadow-md"
            >
              <div>
                ...
                <p className="font-sans text-xs text-[#bbcabf]/70 leading-relaxed mt-2">
                  {gem.description}
                </p>
              </div>

              <div className="grid grid-cols-2 gap-4 border-t border-[#3c4a42]/20 pt-3 mt-1 font-mono text-[10px]">
                <div>
                  <span className="text-[#bbcabf]/40 block text-[8px] uppercase">Est. Valuation</span>
